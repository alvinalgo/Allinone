<template>
  <div class="view-wrapper">
    <h1>Full List</h1>
    <div class="align">
      <md-button class="md-dense md-raised" :to="{name: 'full_list', params: {start_index: valid_page(false)}}">&lt;</md-button>
      <md-button class="md-dense md-raised" :to="{name: 'full_list', params: {start_index: valid_page(true)}}">&gt;</md-button>
